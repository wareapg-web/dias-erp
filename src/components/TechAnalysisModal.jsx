                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  (temporaryPayablesHint.totalInvoice > 0.005 ||
                    ...
                    <button
                      ...
                      className="rounded-lg border border-amber-500/30 bg-amber-500/10 px-3 py-1.5 text-center text-sm font-bold leading-tight text-amber-100 transition hover:bg-amber-500/15"
                    >
